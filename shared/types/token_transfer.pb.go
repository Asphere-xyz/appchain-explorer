...
func (m *TokenTransfer) GetAddressFrom() string {
	if m != nil {
...
func (m *TokenTransfer) GetAddressTo() string {
	if m != nil {
		return m.AddressTo
	}
	return ""
...
func (m *TokenTransfer) GetTokenContract() string {
	if m != nil {
...
func (m *TokenTransfer) GetSymbol() string {
	if m != nil {
		return m.Symbol
	}
	return ""
...
func (m *TokenTransfer) GetDecimals() uint64 {
	if m != nil {
		return m.Decimals
	}
	return 0
...
var fileDescriptor_4dee5df8e2b2416f = []byte{
	...
	,
}
...
func (m *TokenTransfer) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Decimals != 0 {
		i = encodeVarintTokenTransfer(dAtA, i, uint64(m.Decimals))
		i--
		dAtA[i] = 0x38
	}
	if len(m.Symbol) > 0 {
		...
		i = encodeVarintTokenTransfer(dAtA, i, uint64(len(m.Symbol)))
		i--
		dAtA[i] = 0x32
	}
	if m.Amount != 0 {
...
func (m *TokenTransfer) Size() (n int) {
	...
	if m.Decimals != 0 {
		n += 1 + sovTokenTransfer(uint64(m.Decimals))
	}
	if m.XXX_unrecognized != nil {
